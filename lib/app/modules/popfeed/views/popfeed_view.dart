...
PopfeedController controller = Get.put(PopfeedController());
Stream article = FirebaseFirestore.instance.collection('news').snapshots();


class PopularFeed1 extends StatefulWidget {
  @override
  _PopularFeed1State createState() => _PopularFeed1State();
}

class _PopularFeed1State extends State<PopularFeed1>
