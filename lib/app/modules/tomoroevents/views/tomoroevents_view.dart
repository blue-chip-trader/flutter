...
class TomoroeventsView extends GetView<TomoroeventsController> {
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(tdate,style: TextStyle(color: Colors.grey),),
        ),
        Expanded(
              ...
              builder: (BuildContext context,
                ...
                return new ListView(
                  physics: BouncingScrollPhysics(parent: AlwaysScrollableScrollPhysics()),
                    children:
                        snapshot.data.docs.where((element) => _calendarController.getDate(element.data()['datetime'])== tdate).map((DocumentSnapshot document) {
