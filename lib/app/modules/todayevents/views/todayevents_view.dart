...
class TodayeventsView extends GetView<TodayeventsController> {
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(mydate,style: TextStyle(color: Colors.grey),),
        ),
        Expanded(
              ...
              builder: (BuildContext context,
                ...
                return new ListView(
                  physics: BouncingScrollPhysics(parent: AlwaysScrollableScrollPhysics()),
                    children:
                        snapshot.data.docs.where((element) => _calendarController.getDate(element.data()['datetime'])== mydate).map((DocumentSnapshot document) {
